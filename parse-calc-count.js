...
exports.JSK3ZH=function(bet, kj, Groupname, betInfo){
	...
	if(bet=='大'){
		...
		var samenum=0;
		bet=bet.split('_');
		if(bet[0]==kj[0]||bet[0]==kj[1]||bet[0]==kj[2]){
			samenum++;
			if(bet[1]==kj[0]||bet[1]==kj[1]||bet[1]==kj[2]){
				samenum++;
			}	
		}
...
if(Groupname=='第一球'){
	...
	qzhhe=parseInt(kj[0],10)+parseInt(kj[1],10)+parseInt(kj[2],10);//飞扬前三大小单双qq 396659781
}else if(Groupname=='中三'){	
	vala=parseInt(kj[1],10);
	valb=parseInt(kj[2],10);
	valc=parseInt(kj[3],10);
	valarr=[vala,valb,valc];
	qzhhe=parseInt(kj[1],10)+parseInt(kj[2],10)+parseInt(kj[3],10);//飞扬前三大小单双qq 396659781
}else if(Groupname=='后三'){	
	vala=parseInt(kj[2],10);
	valb=parseInt(kj[3],10);
	valc=parseInt(kj[4],10);
	valarr=[vala,valb,valc];
	qzhhe=parseInt(kj[2],10)+parseInt(kj[3],10)+parseInt(kj[4],10);//飞扬前三大小单双qq 396659781
}
			if(bet==val){
				count=1;
				return count;
				...
				if(qzhhe>=14 && qzhhe<=27) count=1;
				return count;
			}else if(bet=='和小'){
				if(qzhhe>=0 && qzhhe<=13) count=1;
				return count;
			}else if(bet=='和大'){
				if(qzhhe>=14 && qzhhe<=27) count=1;
				return count;
